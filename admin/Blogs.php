...
if(isset($_POST['save']))
{
    ...
    move_uploaded_file($_FILES['image']['tmp_name'],$uploadfile);
        ...
        mysql_query("insert into Blogs values('','$b_name','$uploadfile','$blog_des','$blog_date')");
...
<main class="mn-inner">
    <span style="font-size: 30px;">Blogs</span>
    <form  action="Blogs.php" method="post" enctype="multipart/form-data" >
    <div class="row">
        <div class="col s12" align="center">

            <div class="input-field col s12">
                <input id="b_name" name="b_name" type="text"  class="validate">
                <label for="b_name" class="">Blog Title</label>
            </div>

            <div class="input-field col s12">
                <textarea id="blog_des" name="blog_des" class="materialize-textarea" ></textarea>
                <label for="blog_des" >Blog Description</label>
        ...
        <div class="row">
            ...
            while($r = mysql_fetch_array($val)){
                ...
                <div class="col s12 m6 l3">
                    <img  src="<?php echo $r['Blog_image_url'];?>" height='150' width='150' alt="image">
                    <div>
